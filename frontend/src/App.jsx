...
const HERO_BIRDS = [
  { name: "Indian Peafowl", image: "/birds/indian-peafowl.jpg" },
  { name: "Great Hornbill", image: "/birds/great-hornbill.jpg" },
  { name: "Sarus Crane", image: "/birds/sarus-crane.jpg" },
  { name: "Indian Roller", image: "/birds/indian-roller.jpg" },
  { name: "Greater Flamingo", image: "/birds/greater-flamingo.jpg" },
];
...
export default function App() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setBirdIndex((prev) => (prev + 1) % HERO_BIRDS.length);
    }, 4000);
    ...
    <div style={{ minHeight: "100vh", background: "var(--mist)" }}>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              ...
              >
                Search and explore India's bird species
              </div>
            </div>
          </div>
      ...
      <main style={{ maxWidth: 800, margin: "0 auto", padding: "40px 24px" }}>
        ...
        <div style={{ marginBottom: 32, textAlign: "center" }}>
          ...
          >
            Explore India's Bird Species
          </h1>

          <img
            src={HERO_BIRDS[birdIndex].image}
            alt={HERO_BIRDS[birdIndex].name}
            className="hero-bird"
          />
